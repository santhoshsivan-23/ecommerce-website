...
| `role` | string | no | Public registration strictly creates `customer` accounts. Seller accounts are created by Admin and Admin accounts register via `/api/auth/admin/register`. |
...
### 4.1b Admin Register (Business Owner)

| | |
| --- | --- |
| **API name** | Register Business Owner |
| **Method** | `POST` |
| **Endpoint** | `{{baseUrl}}/api/auth/admin/register` |
| **Auth** | Public |
| **Headers** | `Content-Type: application/json` |

---

### 4.1c Admin Login (Dedicated Admin Auth)
...
### 4.1d Seller Login (Dedicated Seller Auth)

| | |
| --- | --- |
| **API name** | Seller Login |
| **Method** | `POST` |
| **Endpoint** | `{{baseUrl}}/api/auth/seller/login` |
| **Auth** | Public |
| **Headers** | `Content-Type: application/json` |

---

### 4.2 Login (Customer / General)
